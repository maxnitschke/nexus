...
public enum Message {
	...
	INSUFFICIENT_PERMISSIONS_WARP_DELETE_OTHERS("&4You do not have permissions to delete this warp!"),
	INSUFFICIENT_PERMISSIONS_WARP_MOVE_OTHERS("&4You do not have permissions to move this warp!"),
	...
	INSUFFICIENT_PERMISSIONS_WARP_SET_MULTIPLE("&4You do not have permissions to set multiple warps!"),
	...
	WARP_DELETED("&c&l! &7Warp &f{0} &7has been deleted."),
	...
	WARP_LIST_ENTRY("&f{0}"),
	WARP_LIST_HEADER("&c&l! &7Warp List &8(&fPage {0}&8)"),
	WARP_LIST_SEPERATOR("&7, "),
